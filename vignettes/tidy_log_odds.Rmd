...
The highest log odds bigrams (bigrams more likely to come from each book, compared to the others) involve concepts specific to each novel, such the pump room in *Northanger Abbey* and sister/mother figures in *Sense & Sensibility*. We can make a visualization as well.
